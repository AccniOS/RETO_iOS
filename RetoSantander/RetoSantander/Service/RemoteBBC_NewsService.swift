    ...
    func getBBC_News(completionHandler: @escaping ([[String:String]]?) -> Void) {
        ...
        if let url = URL(string: strUrl) {
            ...
            switch response.result {
                case .success:
                    UserDefaultService.saveData(info: strUrl, key: Default.urlStore)
                ...
                case .failure(let error):
                    ...
                    Utils.openAlert(viewController: vc!, title: NSLocalizedString("errorTitle", comment: ""), message: NSLocalizedString("errorMessage", comment: ""), completionHandler: {})
